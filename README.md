...
* 🤖 **[Macaco Amarelo](https://github.com/BernardoRodriguesEng/Sumo-2kg-Equipe-Macaco-Amarelo-RoboChallenge-BR-2025)**: Software para robô de Sumô (Equipe campeã RoboChallenge).
* 🚗 **[IoT Smart Car](https://github.com/BernardoRodriguesEng/Projeto_Carro_Inteligente_Robo_Challenge)**: Integração de sensores e controle via internet.
* 📍 **[GPS Cashly](https://github.com/BernardoRodriguesEng/Cashly-GPS-Project)**: Gerenciamento de localização e lógica em Dart.
